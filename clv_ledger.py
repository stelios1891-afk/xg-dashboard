...
# Παλια ματς: αναδρομικες εισοδοι h72 απο το git ιστορικο (ledger_h72_backfill.py). Τα Telegram alerts ΔΕΝ αλλαζουν.
ENTRY_H = 72
...
def counts(b):
    """True αν η εγγραφη μετραει στο ιστορικο = εισοδος h72 (≤72ω πριν τη σεντρα, μια ανα ματς & πλευρα).
    Τα παλια ματς (απο 13/9) ξαναχτιστηκαν με ledger_h72_backfill.py απο το git ιστορικο του scanner: ενα pick που ηρθε νωριτερα
    μπαινει με την τιμη της πρωτης σαρωσης μεσα στις 72ω — αν ηταν ακομα ενεργο. Οι παλιες εγγραφες (χωρις h72) μενουν μονο ως αρχειο."""
    return bool(b.get('h72'))
